...
# ///
#
# striplinks.py -- reads from stdin, strips HTML/Markdown links and images, writes to stdout.
#
# Clipboard usage: xclip -selection clipboard -o | uv run striplinks.py | xclip -selection clipboard
